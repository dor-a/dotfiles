# Homebrew Bundle file for macOS development environment
...
brew "kind"                 # Local Kubernetes clusters
brew "eksctl"               # EKS management tool

# Infrastructure as Code
brew "tfenv"                # Terraform version manager
brew "terragrunt"           # Terraform wrapper
brew "ansible"              # Configuration management
brew "crossplane"           # Multi-cloud provisioning tool
...
cask "dockdoor"             # Window previews for macOS dock

# Communication
cask "slack"                # Team communication
cask "discord"              # Community communication
